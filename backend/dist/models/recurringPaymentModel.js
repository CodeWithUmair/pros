...
exports.RecurringPayment = void 0;
const mongoose_1 = __importStar(require("mongoose"));
// 3️⃣ Payee Schema
const payeeSchema = new mongoose_1.default.Schema({
...
const recurringPaymentSchema = new mongoose_1.Schema({
    userId: { type: mongoose_1.default.Schema.Types.ObjectId, ref: "User", required: true },
...
exports.RecurringPayment = mongoose_1.default.model("RecurringPayment", recurringPaymentSchema);
