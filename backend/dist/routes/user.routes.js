...
router.patch("/me/avatar", auth_middleware_1.protect, multer_1.upload.single("file"), user_controller_1.updateAvatar);
router.put("/me/fcm-token", auth_middleware_1.protect, user_controller_1.updateFcmToken);
