...
exports.listUsers = exports.getUser = exports.updateMe = exports.getMe = void 0;
...
const updateMe = (req, res, next) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    try {
        ...
        const updated = yield userService.updateUser(req.user.id, { name, bio });
...
const listUsers = (_req, res, next) => __awaiter(void 0, void 0, void 0, function* () {
    try {
